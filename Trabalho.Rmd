...
These findings reveal an overall improvement in air-pollution-related CRD mortality, particularly in some previously high-burden countries, yet progress remains uneven, with slower reductions in regions characterised by persistent poverty, rapid urbanisation, and limited healthcare access.

## Impact of air pollution on chronic respiratory disease by health system type in 2021

Figure \@ref(fig:health-system) shows how the burden of CRDs caused by
...
(green) show the lowest rates of deaths and disease burden. However, the
...
From Figure \@ref(fig:health-system), it is also clear that most of the burden comes from
...
about 700 per 100,000 in 1990 to roughly 500 per 100,000 by 2021. This
suggests a meaningful reduction in the overall health impact of air
pollution on respiratory diseases.

The decrease is largely driven by a reduction in YLLs, which fell from
...
This pattern suggests that while fewer people are dying prematurely from
pollution-related CRDs, the burden of living with these conditions has
...
DALYs from 1990 to 2019. Similar to our
...
highlighting regional disparities by SDI
